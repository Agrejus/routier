...
async function sqlite3InitModule(moduleArg = {}) {
  ...
  Module.runSQLite3PostLoadInit = async function(sqlite3InitScriptInfo, EmscriptenModule, sqlite3IsUnderTest) {
    ...
    globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
      ...
      cache2.heapSize = 0;
      cache2.memory = null;
      cache2.freeFuncIndexes = [];
      cache2.scopedAlloc = [];
      cache2.scopedAlloc.pushPtr = (ptr) => {
        cache2.scopedAlloc[cache2.scopedAlloc.length - 1].push(ptr);
        return ptr;
      };
      cache2.utf8Decoder = new TextDecoder();
      cache2.utf8Encoder = new TextEncoder("utf-8");
      target.sizeofIR = (n) => {
        switch (n) {
          case "i8":
            return 1;
      ...
      const heapWrappers = function() {
        if (!cache2.memory) cache2.memory = target.memory instanceof WebAssembly.Memory ? target.memory : target.exports.memory;
        else if (cache2.heapSize === cache2.memory.buffer.byteLength) return cache2;
        const b = cache2.memory.buffer;
        cache2.HEAP8 = new Int8Array(b);
        cache2.HEAP8U = new Uint8Array(b);
        cache2.HEAP16 = new Int16Array(b);
        cache2.HEAP16U = new Uint16Array(b);
        cache2.HEAP32 = new Int32Array(b);
        cache2.HEAP32U = new Uint32Array(b);
        cache2.HEAP32F = new Float32Array(b);
        cache2.HEAP64F = new Float64Array(b);
        if (target.bigIntEnabled) if ("undefined" !== typeof BigInt64Array) {
          cache2.HEAP64 = new BigInt64Array(b);
          cache2.HEAP64U = new BigUint64Array(b);
        } else toss("BigInt support is enabled, but the BigInt64Array type is missing.");
        cache2.heapSize = b.byteLength;
        return cache2;
      };
      ...
      target.heapForSize = function(n, unsigned = true) {
        const c = cache2.memory && cache2.heapSize === cache2.memory.buffer.byteLength ? cache2 : heapWrappers();
        switch (n) {
          case Int8Array:
            return c.HEAP8;
          case Uint8Array:
      ...
      const __installFunction = function f(func, sig, scoped) {
        if (scoped && !cache2.scopedAlloc.length) toss("No scopedAllocPush() scope is active.");
        if ("string" === typeof func) {
          const x = sig;
          sig = func;
          func = x;
        ...
        let ptr;
        while (ptr = cache2.freeFuncIndexes.pop()) if (ft.get(ptr)) {
          ptr = null;
          continue;
        } else break;
        if (!ptr) {
        ...
        try {
          ft.set(ptr, func);
          if (scoped) cache2.scopedAlloc.pushPtr(ptr);
          return ptr;
        } catch (e) {
          if (!(e instanceof TypeError)) {
            if (ptr === oldLen) cache2.freeFuncIndexes.push(oldLen);
            throw e;
          }
        }
        try {
      ...
      target.uninstallFunction = function(ptr) {
        ...
        const ft = target.functionTable();
        cache2.freeFuncIndexes.push(ptr);
        const rc = ft.get(ptr);
        ft.set(ptr, null);
        return rc;
      };
      ...
      const typedArrayToString = (typedArray, begin, end) => cache2.utf8Decoder.decode(typedArrayPart(typedArray, begin, end));
      ...
      target.jstrToUintArray = (str, addNul = false) => {
        return cache2.utf8Encoder.encode(addNul ? str + "\0" : str);
      };
      ...
      const __allocCStr = function(jstr, returnWithLength, allocator, funcName) {
        ...
        const u = cache2.utf8Encoder.encode(jstr), ptr = allocator(u.length + 1);
        let toFree = ptr;
        try {
      ...
      target.scopedAllocPush = function() {
        ...
        const a = [];
        cache2.scopedAlloc.push(a);
        return a;
      };
      target.scopedAllocPop = function(state) {
        __affirmAlloc(target, "scopedAllocPop");
        const n = arguments.length ? cache2.scopedAlloc.indexOf(state) : cache2.scopedAlloc.length - 1;
        if (n < 0) toss("Invalid state object for scopedAllocPop().");
        if (0 === arguments.length) state = cache2.scopedAlloc[n];
        cache2.scopedAlloc.splice(n, 1);
        for (let p; p = state.pop(); ) if (target.functionEntry(p)) target.uninstallFunction(p);
        else target.dealloc(p);
      };
      target.scopedAlloc = function(n) {
        if (!cache2.scopedAlloc.length) toss("No scopedAllocPush() scope is active.");
        const p = __asPtrType(target.alloc(n));
        return cache2.scopedAlloc.pushPtr(p);
      };
      Object.defineProperty(target.scopedAlloc, "level", {
        configurable: false,
        enumerable: false,
        get: () => cache2.scopedAlloc.length,
      ...
      cache2.xWrap = /* @__PURE__ */ Object.create(null);
      cache2.xWrap.convert = /* @__PURE__ */ Object.create(null);
      cache2.xWrap.convert.arg = /* @__PURE__ */ new Map();
      cache2.xWrap.convert.result = /* @__PURE__ */ new Map();
      const xArg = cache2.xWrap.convert.arg, xResult = cache2.xWrap.convert.result;
          ...
          if (v2 instanceof Function) {
            ...
            if (pair) {
              if (pair[1]) {
                ...
                try {
                  cache2.scopedAlloc.pushPtr(pair[1]);
                } catch (e) {
                }
              }
      ...
      cache2.xWrap.convertArg = (t, ...args) => __xArgAdapterCheck(t)(...args);
      cache2.xWrap.convertArgNoCheck = (t, ...args) => xArg.get(t)(...args);
      cache2.xWrap.convertResult = (t, v2) => null === t ? v2 : t ? __xResultAdapterCheck(t)(v2) : void 0;
      cache2.xWrap.convertResultNoCheck = (t, v2) => null === t ? v2 : t ? xResult.get(t)(v2) : void 0;
      ...
      target.xWrap.testConvertArg = cache2.xWrap.convertArg;
      target.xWrap.testConvertResult = cache2.xWrap.convertResult;
      return target;
    };
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      ...
      const parseExecArgs = function(db, args) {
        ...
        if (opt.callback || opt.resultRows) switch (void 0 === opt.rowMode ? "array" : opt.rowMode) {
          case "object":
            out2.cbArg = (stmt, cache2) => {
              if (!cache2.columnNames) cache2.columnNames = stmt.getColumnNames([]);
              const row = stmt.get([]);
              const rv = /* @__PURE__ */ Object.create(null);
              for (const i in cache2.columnNames) rv[cache2.columnNames[i]] = row[i];
              return rv;
            };
            break;
          case "array":
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      ...
      const cache2 = Object.assign(/* @__PURE__ */ Object.create(null), {
      ...
      cache2.memBuffer = (id = 0) => cache2.buffer.pool[id] ??= wasm.alloc(cache2.buffer.n);
      cache2.memBufferFree = (id) => {
        const b = cache2.buffer.pool[id];
        if (b) {
          wasm.dealloc(b);
          delete cache2.buffer.pool[id];
        }
      };
      const noop = () => {
      };
      ...
      const validateStorageName = function(n, mayBeJournal = false) {
        ...
        let maxLen = cache2.keySize - 1;
        if (cache2.rxJournalSuffix.test(n)) {
      ...
      const deleteStorage = function(store) {
        const other = cache2.rxJournalSuffix.test(store.jzClass) ? store.jzClass.replace(cache2.rxJournalSuffix, "") : store.jzClass + "-journal";
        kvvfs?.log?.xClose && debug("cleaning up storage handles [", store.jzClass, other, "]", store);
        delete cache2.storagePool[store.jzClass];
        delete cache2.storagePool[other];
        if (!sqlite3.__isUnderTest) {
          delete store.storage;
          delete store.refc;
        }
      };
      const installStorageAndJournal = (store) => cache2.storagePool[store.jzClass] = cache2.storagePool[store.jzClass + "-journal"] = store;
      const nameOfThisThreadStorage = ".";
      cache2.storagePool = Object.assign(/* @__PURE__ */ Object.create(null), { [nameOfThisThreadStorage]: newStorageObj(nameOfThisThreadStorage) });
      if (globalThis.Storage) {
        if (globalThis.localStorage instanceof globalThis.Storage) cache2.storagePool.local = newStorageObj("local", globalThis.localStorage);
        if (globalThis.sessionStorage instanceof globalThis.Storage) cache2.storagePool.session = newStorageObj("session", globalThis.sessionStorage);
      }
      cache2.builtinStorageNames = Object.keys(cache2.storagePool);
      const isBuiltinName = (n) => cache2.builtinStorageNames.indexOf(n) > -1;
      for (const k2 of Object.keys(cache2.storagePool)) {
        const orig = cache2.storagePool[k2];
        cache2.storagePool[k2 + "-journal"] = orig;
      }
      cache2.setError = (e = void 0, dfltErrCode = capi.SQLITE_ERROR) => {
        if (e) {
          cache2.lastError = e;
          return e.resultCode | 0 || dfltErrCode;
        }
        delete cache2.lastError;
        return 0;
      };
      cache2.popError = () => {
        const e = cache2.lastError;
        delete cache2.lastError;
        return e;
      };
          ...
          for (const ear of store.listeners) {
            ...
            if (f) {
              ...
              if ("write" === eventName && ear.decodePages && +args[0] > 0) {
                ...
                z0 ??= cache2.memBuffer(10);
                z1 ??= cache2.memBuffer(11);
                const u = u8enc.encode(args[1]);
                const heap = wasm.heap8u();
                heap.set(u, Number(z0));
                heap[wasm.ptr.addn(z0, u.length)] = 0;
                const rc = kvvfsDecode(z0, z1, cache2.buffer.n);
                if (rc > 0) {
      ...
      const storageForZClass = (zClass) => "string" === typeof zClass ? cache2.storagePool[zClass] : cache2.storagePool[wasm.cstrToJs(zClass)];
        ...
        recordHandler: {
          ...
          xRcrdWrite: (zClass, zKey, zData) => {
            try {
              ...
              return cache2.setError(e, capi.SQLITE_IOERR);
            }
          },
        ...
        vfs: {
          xOpen: function(pProtoVfs, zName, pProtoFile, flags, pOutFlags) {
            ...
            try {
              ...
              if (flags & (capi.SQLITE_OPEN_MAIN_DB | capi.SQLITE_OPEN_TEMP_DB | capi.SQLITE_OPEN_TRANSIENT_DB) && cache2.rxJournalSuffix.test(jzClass)) toss3(capi.SQLITE_ERROR, "DB files may not have a '-journal' suffix.");
              ...
              if (s) {
                ...
                const nm = jzClass.replace(cache2.rxJournalSuffix, "");
                s = newStorageObj(nm);
          ...
          xDelete: function(pVfs2, zName, iSyncFlag) {
            ...
            try {
              ...
              if (cache2.rxJournalSuffix.test(jzName)) recordHandler.xRcrdDelete(zName, cache2.zKeyJrnl);
              return 0;
            } catch (e) {
              warn("xDelete", e);
              return cache2.setError(e);
          ...
          xAccess: function(pProtoVfs, zPath, flags, pResOut) {
            ...
            try {
              ...
              if (s) {
                const key = s.keyPrefix + (cache2.rxJournalSuffix.test(jzPath) ? "jrnl" : "1");
      ...
      try {
        util.assert(cache2.buffer.n > 1024 * 129, "Heap buffer is not large enough");
      ...
      const sqlite3_js_kvvfs_export = function callee3(...args) {
          ...
          if (!keyPrefix || k2.startsWith(keyPrefix)) {
            ...
            switch (kk) {
              ...
              default:
                ...
                if (opt.decodePages) {
                  const spg = s.getItem(k2), n2 = spg.length, z = cache2.memBuffer(0), zDec = cache2.memBuffer(1), heap = wasm.heap8u();
                  let i2 = 0;
                  for (; i2 < n2; ++i2) heap[wasm.ptr.add(z, i2)] = spg.codePointAt(i2) & 255;
                  heap[wasm.ptr.add(z, i2)] = 0;
                  const nDec = kvvfsDecode(z, zDec, cache2.buffer.n);
        ...
        if (opt.decodePages) cache2.memBufferFree(1);
      ...
      const sqlite3_js_kvvfs_import = function(exp, overwrite = false) {
        ...
        try {
          ...
          if (exp.pages[0] instanceof Uint8Array) exp.pages.forEach((u, ndx) => {
            const n = u.length;
            zEnc ??= cache2.memBuffer(1);
            const zBin = cache2.memBuffer(0), heap = wasm.heap8u();
            heap.set(u, Number(zBin));
            heap[wasm.ptr.addn(zBin, n)] = 0;
            const rc = kvvfsEncode(zBin, n, zEnc);
            util.assert(rc < cache2.buffer.n, "Impossibly long output - possibly smashed the heap");
          ...
          if (zEnc) cache2.memBufferFree(1);
        }
        return this;
      };
      ...
      const sqlite3_js_kvvfs_unlink = function(name) {
        ...
        if (!store || kvvfsIsPersistentName(store.jzClass) || isBuiltinName(store.jzClass) || cache2.rxJournalSuffix.test(name)) return false;
      ...
      if (sqlite3.oo1?.DB) {
        ...
        sqlite3.oo1.JsStorageDb.defaultStorageName = cache2.storagePool.session ? "session" : nameOfThisThreadStorage;
      ...
      if (sqlite3.__isUnderTest && sqlite3.vtab) {
        ...
        const ProtoCursor = Object.assign(/* @__PURE__ */ Object.create(null), { row: function() {
          return cache2.storagePool[this.names[this.rowid]];
        } });
        Object.assign(Object.create(ProtoCursor), {
          rowid: 0,
          names: Object.keys(cache2.storagePool).filter((v2) => !cache2.rxJournalSuffix.test(v2))
        });
          ...
          return f.mod ??= new sqlite3.capi.sqlite3_module().setupModule({
            ...
            methods: {
              ...
              xBestIndex: function(pVtab, pIdxInfo) {
                ...
                pii.$estimatedRows = cache2.storagePool.size;
                pii.$estimatedCost = 1;
                pii.dispose();
                return 0;
              }
...
// plugins/sqlite/src/drivers/wasmPool.ts
var POOL_HEADROOM = 8;
var POOL_GROWTH = 8;
var ensurePoolCapacity = async (pool) => {
...
var poolFullError = (pool, databaseName) => new Error(
  `The OPFS SAH pool is full at ${pool.getCapacity()} files, so '${databaseName}' could not be opened. ${pool.getFileCount()} are in use. Every database held open takes a slot; destroy the stores you have finished with, which unlinks their file and returns it to the pool.`
);
var isPoolFull = (error) => /pool is full/i.test(error instanceof Error ? error.message : String(error));
...
var SQLITE_BLOB = 4;
var SQLITE_NULL = 5;
var readColumn = (raw, statement, column) => {
...
var readRowInto = (raw, statement, columnCount, into) => {
  for (let i = 0; i < columnCount; i++) {
    into[i] = readColumn(raw, statement, i);
  }
  return into;
};
var rawSqliteFrom = (wasm) => {
...
// plugins/sqlite/src/drivers/wasmRows.ts
var readRows = (raw, statement) => {
  const rows = [];
...
__webpack_require__.d(__webpack_exports__, {
  ...
  FG: () => (
    /* reexport */
    /* inlined export .TRANSFER_VERSION */
    1
  ),
  rq: () => (
    /* reexport */
  ...
  ze: () => (
    /* reexport */
    parsedValueTransferTypes
  )
});
var TRANSFER_VERSION = 1;
var nullByteLength = (rowCount) => rowCount + 7 >> 3;
var assertTransferVersion = (version) => {
  if (version !== TRANSFER_VERSION) {
    throw new Error(`transfer codec version ${version} is not supported`);
  }
};
var assertColumnLayout = (plan, names) => {
...
var TypedFiller = class {
  ...
  emit(rowCount, transferables) {
    const data = rowCount === /* inlined export .CHUNK_ROWS */
    4096 ? this.data : this.data.slice(0, rowCount);
    const nulls = rowCount === /* inlined export .CHUNK_ROWS */
    4096 ? this.nulls : this.nulls.slice(0, nullByteLength(rowCount));
...
var Float64Filler = class extends TypedFiller {
  encoding = "float64";
  allocate() {
...
var DateFiller = class extends TypedFiller {
  encoding = "date-f64";
  allocate() {
    return new Float64Array(
      /* inlined export .CHUNK_ROWS */
...
var BooleanFiller = class extends TypedFiller {
...
var asJsonText = (value) => typeof value === "string" ? value : null;
var asStringifiedJson = (value) => {
  try {
...
var ChunkEncoder = class {
  ...
  get isFull() {
    return this.rows === /* inlined export .CHUNK_ROWS */
    4096;
  }
  ...
  appendRow(values) {
    if (this.isFull) {
      throw new Error(`The chunk is full at ${/* inlined export .CHUNK_ROWS */
      4096} rows; take it before appending another.`);
    }
...
var isTransferJsonError = (error) => typeof error?.transferJsonColumn === "string";
var jsonError = (column, cause) => Object.assign(new Error(`The transferred JSON document for column '${column}' did not parse, so this column holds text that is not JSON. Retry the request without a transfer plan. Cause: ${cause?.message ?? String(cause)}`), {
  transferJsonColumn: column
});
var effectiveColumns = (plan, chunk) => plan.columns.map((column) => {
...
var cacheKey = (columns) => "v1|" + columns.map((column) => `${JSON.stringify(column.name)}:${column.encoding}`).join("|");
var CACHE_CAPACITY = 64;
...
var clearDecoderCache = () => cache.clear();
var rowValue = (column, index) => {
...
var literalKey = (name) => name === "__proto__" ? `[${JSON.stringify(name)}]` : JSON.stringify(name);
var isTyped = (encoding) => encoding === "float64" || encoding === "date-f64" || encoding === "boolean-byte";
var decoderSource = (columns) => {
  const lines = [
    '"use strict";',
...
var generationSupported = null;
var isTransferCodecSupported = () => {
...
var buildDecoder = (columns) => new Function("chunk", "json", decoderSource(columns));
var decoderFor = (columns) => {
...
var parseJsonColumns = (columns, chunk) => {
...
var ownsItsShape = (property) => property.valueSerializer != null || property.valueDeserializer != null || property.transform != null || property.functionBody != null;
var transferEncodingFor = (column, strategy) => {
...
var buildTransferPlan = (columns, strategy) => {
  if (columns.length === 0) {
    return void 0;
  }
...
// plugins/sqlite/src/drivers/wasmChunks.ts
var streamChunks = (raw, statement, plan, emit) => {
  const names = statement.getColumnNames();
  __webpack_exports__assertColumnLayout(plan, names);
  const encoder = new __webpack_exports__ChunkEncoder(plan);
  const pointer = statement.pointer;
  const columnCount = names.length;
  const values = new Array(columnCount);
...
// plugins/sqlite/src/drivers/wasmWorker.ts
var post = (response, transferables = []) => {
  self.postMessage(response, transferables);
};
var databases = /* @__PURE__ */ new Map();
var openings = /* @__PURE__ */ new Map();
var rawSqlite = null;
var rawApi = () => {
  if (rawSqlite == null) {
...
var loadModule = () => {
  if (modulePromise == null) {
    modulePromise = sqlite3_bundler_friendly_default().then((sqlite3) => {
...
var loadPool = async (storage) => {
  ...
  if (typeof sqlite3.installOpfsSAHPoolVfs !== "function") {
    throw new Error(
      "This build of @sqlite.org/sqlite-wasm cannot install the OPFS SAH pool VFS. Use `wasmDriver({ storage: 'memory' })` if persistence is not required."
    );
  }
  if (poolPromise == null) {
...
var openDatabase = (databaseName, storage) => {
...
var beginOpen = async (databaseName, storage) => {
  const sqlite3 = await loadModule();
  const pool = await loadPool(storage);
  if (pool != null) {
    await ensurePoolCapacity(pool);
  }
  const database = pool == null ? new sqlite3.oo1.DB(":memory:") : openPooled(pool, databaseName);
  databases.set(databaseName, database);
  return database;
};
var openPooled = (pool, databaseName) => {
  try {
