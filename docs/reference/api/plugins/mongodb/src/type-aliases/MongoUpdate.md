...
Defined in: [plugins/mongodb/src/driver.ts:21](https://github.com/Agrejus/routier/blob/main/plugins/mongodb/src/driver.ts#L21)
...
Defined in: [plugins/mongodb/src/driver.ts:27](https://github.com/Agrejus/routier/blob/main/plugins/mongodb/src/driver.ts#L27)
