...
[routier-collection](../../../README.md) / [core/src](../README.md) / SchemaTransform

# Class: SchemaTransform\<T, TModifiers\>

Defined in: [core/src/schema/table/SchemaTransform.ts:30](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/table/SchemaTransform.ts#L30)
...
`TModifiers` *extends* [`SchemaModifiers`](../type-aliases/SchemaModifiers.md) = `never`

## Constructors

### Constructor

> **new SchemaTransform**\<`T`, `TModifiers`\>(`transform`): `SchemaTransform`\<`T`, `TModifiers`\>

Defined in: [core/src/schema/table/SchemaTransform.ts:53](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/table/SchemaTransform.ts#L53)

#### Parameters

##### transform

[`PropertyTransform`](../type-aliases/PropertyTransform.md)\<`T`\>

#### Returns

`SchemaTransform`\<`T`, `TModifiers`\>
...
Defined in: [core/src/schema/table/SchemaTransform.ts:32](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/table/SchemaTransform.ts#L32)
...
> **bindTo**(`underlying`): `SchemaTransform`\<`T`, `TModifiers`\>

Defined in: [core/src/schema/table/SchemaTransform.ts:41](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/table/SchemaTransform.ts#L41)
