...
[routier-collection](/reference/api/README) / [core/src](/reference/api/core/src/README) / SchemaComputed
...
`TModifiers` *extends* [`SchemaModifiers`](/reference/api/core/src/type-aliases/SchemaModifiers) = `"computed"`
...
> **type**: [`SchemaTypes`](/reference/api/core/src/enumerations/SchemaTypes) = `SchemaTypes.Computed`
...
> **tracked**(): [`SchemaTracked`](/reference/api/core/src/classes/SchemaTracked)\<`T`, `TModifiers`\>
...
[`SchemaTracked`](/reference/api/core/src/classes/SchemaTracked)\<`T`, `TModifiers`\>
