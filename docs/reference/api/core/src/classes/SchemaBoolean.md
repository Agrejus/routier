...
[routier-collection](/reference/api/README) / [core/src](/reference/api/core/src/README) / SchemaBoolean
...
> **type**: [`SchemaTypes`](/reference/api/core/src/enumerations/SchemaTypes) = `SchemaTypes.Boolean`

Defined in: [core/src/schema/property/types/SchemaBoolean.ts:17](https://github.com/Agrejus/routier/blob/ae307d61bf9883ec014a438be7cbd96d2060d092/core/src/schema/property/types/SchemaBoolean.ts#L17)
...
> **array**(): [`SchemaArray`](/reference/api/core/src/classes/SchemaArray)\<`SchemaBoolean`\<`T`, `TModifiers`\>, `TModifiers`\>
...
[`SchemaArray`](/reference/api/core/src/classes/SchemaArray)\<`SchemaBoolean`\<`T`, `TModifiers`\>, `TModifiers`\>
