...
[routier-collection](../../../README.md) / [core/src](../README.md) / SchemaTracked

# Class: SchemaTracked\<T, TModifiers\>

Defined in: [core/src/schema/property/modifiers/SchemaTracked.ts:7](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/property/modifiers/SchemaTracked.ts#L7)
...
> **new SchemaTracked**\<`T`, `TModifiers`\>(`current`): `SchemaTracked`\<`T`, `TModifiers`\>

Defined in: [core/src/schema/property/modifiers/SchemaTracked.ts:12](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/property/modifiers/SchemaTracked.ts#L12)
...
Defined in: [core/src/schema/property/modifiers/SchemaTracked.ts:9](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/property/modifiers/SchemaTracked.ts#L9)
...
> **key**(): `T` *extends* [`IdType`](../type-aliases/IdType.md) ? [`SchemaKey`](SchemaKey.md)\<`T`\<`T`\>, `"key"` \| `TModifiers`\> : `never`

Defined in: [core/src/schema/property/modifiers/SchemaTracked.ts:18](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/property/modifiers/SchemaTracked.ts#L18)

#### Returns

`T` *extends* [`IdType`](../type-aliases/IdType.md) ? [`SchemaKey`](SchemaKey.md)\<`T`\<`T`\>, `"key"` \| `TModifiers`\> : `never`
...
Defined in: [core/src/schema/property/modifiers/SchemaTracked.ts:22](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/property/modifiers/SchemaTracked.ts#L22)
...
Defined in: [core/src/schema/property/modifiers/SchemaTracked.ts:26](https://github.com/Agrejus/routier/blob/2d0e42a9b099264b175f71d2bfb8e465ace0de7e/core/src/schema/property/modifiers/SchemaTracked.ts#L26)
