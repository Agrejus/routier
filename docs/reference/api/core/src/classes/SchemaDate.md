...
[routier-collection](/reference/api/README) / [core/src](/reference/api/core/src/README) / SchemaDate
...
> **type**: [`SchemaTypes`](/reference/api/core/src/enumerations/SchemaTypes) = `SchemaTypes.Date`
...
> **array**(): [`SchemaArray`](/reference/api/core/src/classes/SchemaArray)\<`SchemaDate`\<`T`, `TModifiers`\>, `TModifiers`\>
...
[`SchemaArray`](/reference/api/core/src/classes/SchemaArray)\<`SchemaDate`\<`T`, `TModifiers`\>, `TModifiers`\>
