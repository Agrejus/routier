...
[routier-collection](/reference/api/README) / [core/src](/reference/api/core/src/README) / SchemaReadonly
...
> **deserializer**(`deserializer`): [`SchemaDeserialize`](/reference/api/core/src/classes/SchemaDeserialize)\<`T`, `"deserialize"` \| `TModifiers`\>
...
> **serializer**(`serializer`): [`SchemaSerialize`](/reference/api/core/src/classes/SchemaSerialize)\<`T`, `"deserialize"` \| `TModifiers`\>
...
[`SchemaSerialize`](/reference/api/core/src/classes/SchemaSerialize)\<`T`, `"deserialize"` \| `TModifiers`\>
