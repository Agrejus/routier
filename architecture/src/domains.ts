...
export const DOMAINS: readonly Domain[] = [
    ...
    },
    {
        ...
        rules: [
            "IDbPlugin is FROZEN at query, destroy and bulkPersist, plus the databaseName identifying what it talks to. It will never gain functionality — it does not need any. A feature that seems to need a fourth method is either a wrapper plugin or a translator.",
