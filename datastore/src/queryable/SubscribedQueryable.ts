...
export class SubscribedQueryable<Root extends {}, Shape, U> extends SelectionQueryable<Root, Shape, U> {
    ...
    where(expression: Filter<InferType<Shape>>): SubscribedQueryable<Root, Shape, U>;
    where<P extends {}>(selector: ParamsFilter<InferType<Shape>, P>, params: P): SubscribedQueryable<Root, Shape, U>;
