...
export class QueryableAsync<Root extends {}, Shape> extends SelectionQueryableAsync<Root, Shape> {
    ...
    where(expression: Filter<InferType<Shape>>): QueryableAsync<Root, Shape>;
    where<P extends {}>(selector: ParamsFilter<InferType<Shape>, P>, params: P): QueryableAsync<Root, Shape>;
